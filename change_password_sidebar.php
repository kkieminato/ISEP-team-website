<div class="span3" id="sidebar">
	...
	<br>
	<center>
	<li><a style="text-decoration: none;font-size:25px;"><?php echo $row['firstname'] . " " . $row['lastname'];  ?></a></li>
	<li><a  style="text-decoration: none;font-size:15px;">Teacher</a></li>	
</center>
	</ul>
				<li class=""><a href="dasboard_teacher.php"><i class="icon-chevron-right"></i><i class="icon-chevron-left"></i>&nbsp;Back</a></li>
				<li class=""><a href="teacher_generalSubject.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-list-alt"></i>&nbsp;General</a></li>
