						...
						<ul	 class="da-thumbs">
										...
										?>
											<li id="del<?php echo $id; ?>">
												<a href="teacher_generalSubject.php<?php echo '?id='.$id; ?>">
												...
												<a title="Click here to Delete the Class" href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-trash"></i> Remove</a>	
