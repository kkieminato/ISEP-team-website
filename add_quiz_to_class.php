                                ...
                                <div class="span12">
									...
									<a href="teacher_quiz.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<input type="date" class="span3" name="due_date" id="inputPassword" placeholder="Due Date" required>
											</div>
										</div>
				...
				<tbody>
					...
					<?php } ?>
										...
										if (isset($_POST['save'])){
											...
											for($i=0; $i < $N; $i++)
											{
												mysqli_query($conn,"insert into class_quiz (teacher_class_id,quiz_time,quiz_id,due_date) values('$id[$i]','$time','$quiz_id','$due_date ')")or die(mysqli_error());
												...
												mysqli_query($conn,"insert into notification (teacher_class_id,notification,due_date ,date_of_notification,link) value('$id[$i]','$name_notification','$due_date ',NOW(),'student_quiz_list.php')")or die(mysqli_error());
