...
mysqli_query($conn,"update sms_notification SET student_number='$student_number'  where teacher_class_id='$get_id'");
                                                ?>
                                            <script>
												window.location = 'remind_student_class_edit.php<?php echo '?id=' . $get_id; ?>';
											</script>
                                            <?php }?>
                                        </div>
                                    </div>
