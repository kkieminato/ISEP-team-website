<nav class="sidebar">
    ...
    <header>
        <div class="image-text">
            <span class="image">
            <img title="Change Avatar" tabindex="-1" href="#myModal" data-toggle="modal" src="admin/<?php echo $row['location']; ?>" width="124" height="140" class="profile-image img-circle">
            ...
            <ul class="menu-links">
                <li class="nav-link ">
                    <a href="dasboard_teacher.php">
                        ...
                        <span  class="text nav-text active">My Class</span>
                    </a>
                </li>
			...
			?>
                ...
                <li class="nav-link">
                    <a href="teacher_share.php">
                        <i title="Click here to go to Share your files" class='bx bx-wallet icon'></i>
                        <span  class="text nav-text">Shared Files</span>
                    </a>
                </li>
